...
function register ({ config }) {
  ...
  this.once('contentClassified', ({ contentCatalog }) => {
    ...
    const unusedImages = findUnusedImages(contentCatalog, imageReferences, extensionToIgnore, logger)
  ...
  function findUnusedImages (contentCatalog, imageReferences, extensionToIgnore, logger) {
